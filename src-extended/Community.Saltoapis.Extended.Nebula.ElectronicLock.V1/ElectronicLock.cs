namespace Saltoapis.Nebula.ElectronicLock.V1
{
...
#endif
    {
        ...
        public bool Equals(ElectronicLock other)
        {
            ...
            if ((Extender != other.Extender) || (AccessPoint != other.AccessPoint)) return false;
            ...
            if ((LowBattery != other.LowBattery) || (!Equals(LastEventTime, other.LastEventTime))) return false;
            if ((CalibrationSettings != other.CalibrationSettings) || (ForceRotateCarriageEnd != other.ForceRotateCarriageEnd)) return false;
            if ((!Equals(HoldBackLatchDuration, other.HoldBackLatchDuration)) || (ParentDeviceCase != other.ParentDeviceCase)) return false;
