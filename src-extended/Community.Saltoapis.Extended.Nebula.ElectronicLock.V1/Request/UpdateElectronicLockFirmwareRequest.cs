namespace Saltoapis.Nebula.ElectronicLock.V1.Request
{
...
#endif
    {
        ...
        public static MessageParser<UpdateElectronicLockFirmwareRequest> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => ElectronicLockReflection.Descriptor.MessageTypes[20];}
        ...
        {
            get => electronicLock_; set => electronicLock_ = ProtoPreconditions.CheckNotNull(value, "value");}
...
return ElectronicLock != other.ElectronicLock ? false : Equals(_unknownFields, other._unknownFields);
        }
