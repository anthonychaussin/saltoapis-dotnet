namespace Saltoapis.Nebula.DigitalKey.V1.Request
{
...
#endif
    {
        ...
        public static MessageParser<ListDigitalKeysRequest> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => DigitalKeyReflection.Descriptor.MessageTypes[2];}
        ...
        public bool Equals(ListDigitalKeysRequest other)
        {
            ...
            if ((PageSize != other.PageSize) || (PageToken != other.PageToken) || (Filter != other.Filter) || (OrderBy != other.OrderBy)) return false;
