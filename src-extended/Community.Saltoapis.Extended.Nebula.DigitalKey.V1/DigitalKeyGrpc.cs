...
namespace Saltoapis.Nebula.DigitalKey.V1
{
    ...
    public static partial class DigitalKeyService
    {
        ...
        static readonly Marshaller<GetDigitalKeyRequest> __Marshaller_salto_nebula_digitalkey_v1_GetDigitalKeyRequest = GrpcMessageHelper.CreateMarshaller(GetDigitalKeyRequest.Parser);

        static readonly Marshaller<DigitalKey> __Marshaller_salto_nebula_digitalkey_v1_DigitalKey = GrpcMessageHelper.CreateMarshaller(DigitalKey.Parser);

        static readonly Marshaller<ListDigitalKeysRequest> __Marshaller_salto_nebula_digitalkey_v1_ListDigitalKeysRequest = GrpcMessageHelper.CreateMarshaller(ListDigitalKeysRequest.Parser);

        static readonly Marshaller<ListDigitalKeysResponse> __Marshaller_salto_nebula_digitalkey_v1_ListDigitalKeysResponse = GrpcMessageHelper.CreateMarshaller(ListDigitalKeysResponse.Parser);

        static readonly Marshaller<GetDigitalKeyAccessPointRequest> __Marshaller_salto_nebula_digitalkey_v1_GetDigitalKeyAccessPointRequest = GrpcMessageHelper.CreateMarshaller(GetDigitalKeyAccessPointRequest.Parser);

        static readonly Marshaller<DigitalKeyAccessPoint> __Marshaller_salto_nebula_digitalkey_v1_DigitalKeyAccessPoint = GrpcMessageHelper.CreateMarshaller(DigitalKeyAccessPoint.Parser);

        static readonly Marshaller<ListDigitalKeyAccessPointsRequest> __Marshaller_salto_nebula_digitalkey_v1_ListDigitalKeyAccessPointsRequest = GrpcMessageHelper.CreateMarshaller(ListDigitalKeyAccessPointsRequest.Parser);

        static readonly Marshaller<ListDigitalKeyAccessPointsResponse> __Marshaller_salto_nebula_digitalkey_v1_ListDigitalKeyAccessPointsResponse = GrpcMessageHelper.CreateMarshaller(ListDigitalKeyAccessPointsResponse.Parser);

        static readonly Marshaller<SyncDigitalKeyAccessPointsRequest> __Marshaller_salto_nebula_digitalkey_v1_SyncDigitalKeyAccessPointsRequest = GrpcMessageHelper.CreateMarshaller(SyncDigitalKeyAccessPointsRequest.Parser);
        ...
        static readonly Marshaller<UnlockDigitalKeyAccessPointRequest> __Marshaller_salto_nebula_digitalkey_v1_UnlockDigitalKeyAccessPointRequest = GrpcMessageHelper.CreateMarshaller(UnlockDigitalKeyAccessPointRequest.Parser);
