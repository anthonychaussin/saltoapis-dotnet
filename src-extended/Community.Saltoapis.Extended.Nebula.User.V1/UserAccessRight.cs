namespace Saltoapis.Nebula.User.V1
{
...
#endif
    {
        ...
        public static MessageParser<UserAccessRight> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => UserReflection.Descriptor.MessageTypes[1];}
        ...
        {
            get => accessRight_; set => accessRight_ = ProtoPreconditions.CheckNotNull(value, "value");}
        ...
        public bool Equals(UserAccessRight other)
        {
            ...
            if ((Name != other.Name) || (AccessRight != other.AccessRight) || (DisplayName != other.DisplayName) || (!schedules_.Equals(other.schedules_)) || (!effectiveSchedules_.Equals(other.effectiveSchedules_)) || (!Equals(ActivateTime, other.ActivateTime)) || (!Equals(ExpireTime, other.ExpireTime)) || (Manager != other.Manager)) return false;
