namespace Saltoapis.Nebula.User.V1
{
...
#endif
    {
        ...
        public static MessageParser<User> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => UserReflection.Descriptor.MessageTypes[0];}
        ...
        private static readonly string ParentDefaultValue = "";
        ...
        {
            get => parent_ ?? ParentDefaultValue; set => parent_ = ProtoPreconditions.CheckNotNull(value, "value");}
        /// <summary>Gets whether the "parent" field is set</summary>
        public bool HasParent => parent_ != null;
        /// <summary>Clears the value of the "parent" field</summary>
        public void ClearParent() => parent_ = null;
        ...
        {
            get => givenName_; set => givenName_ = ProtoPreconditions.CheckNotNull(value, "value");}
        /// <summary>Field number for the "family_name" field.</summary>
        public const int FamilyNameFieldNumber = 4;
        private static readonly string FamilyNameDefaultValue = "";
        ...
        {
            get => familyName_ ?? FamilyNameDefaultValue; set => familyName_ = ProtoPreconditions.CheckNotNull(value, "value");}
        /// <summary>Gets whether the "family_name" field is set</summary>
        public bool HasFamilyName => familyName_ != null;
        /// <summary>Clears the value of the "family_name" field</summary>
        public void ClearFamilyName() => familyName_ = null;
        ...
        public string Email
        {
            get => email_ ?? EmailDefaultValue; set => email_ = ProtoPreconditions.CheckNotNull(value, "value");}
        /// <summary>Gets whether the "email" field is set</summary>
        public bool HasEmail => email_ != null;
        /// <summary>Clears the value of the "email" field</summary>
        public void ClearEmail() => email_ = null;
        ...
        {
            get => activateTime_; set => activateTime_ = value;}
        ...
        public bool Blocked
        {
            get => blocked_; set => blocked_ = value;}
        ...
        public bool Equals(User other)
        {
            ...
            if ((Name != other.Name) || (Parent != other.Parent) || (GivenName != other.GivenName) || (FamilyName != other.FamilyName) || (DisplayName != other.DisplayName) || (Email != other.Email) || (!Equals(ActivateTime, other.ActivateTime)) || (!Equals(ExpireTime, other.ExpireTime)) || (Photo != other.Photo) || (PhotoUri != other.PhotoUri) || (!Equals(CardKey, other.CardKey)) || (!Equals(ElectronicKey, other.ElectronicKey)) || (!Equals(AppKey, other.AppKey)) || (!Equals(WalletKey, other.WalletKey)) || (!Equals(Passcode, other.Passcode)) || (Blocked != other.Blocked) || Manager != other.Manager) return false;
