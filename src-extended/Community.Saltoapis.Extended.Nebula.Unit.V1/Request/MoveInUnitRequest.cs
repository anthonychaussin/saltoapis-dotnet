namespace Saltoapis.Nebula.Unit.V1.Request
{
...
#endif
    {
        ...
        public static MessageParser<MoveInUnitRequest> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => UnitReflection.Descriptor.MessageTypes[10];}
      ...
      switch(tag)
      {
        ...
        public static partial class Types
        {
...
#endif
            {
                ...
                public static MessageParser<Occupant> Parser { get => _parser;}

                public static MessageDescriptor Descriptor
                {
                    get => MoveInUnitRequest.Descriptor.NestedTypes[0];}
                ...
                public bool Equals(Occupant other)
                {
                    if (other is null) return false;
                    if (ReferenceEquals(other, this)) return true;
                    if ((GivenName != other.GivenName) || (FamilyName != other.FamilyName) || (Email != other.Email) || (!accessRights_.Equals(other.accessRights_)) || !iamRoles_.Equals(other.iamRoles_)) return false;
                    return Equals(_unknownFields, other._unknownFields);
                }
