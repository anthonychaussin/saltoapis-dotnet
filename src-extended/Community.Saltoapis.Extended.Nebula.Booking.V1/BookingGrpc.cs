...
namespace Saltoapis.Nebula.Booking.V1
{
    ...
    public static partial class BookingService
    {
        ...
        static readonly Marshaller<CreateBookingRequest> __Marshaller_salto_nebula_booking_v1_CreateBookingRequest = GrpcMessageHelper.CreateMarshaller(CreateBookingRequest.Parser);

        static readonly Marshaller<Booking> __Marshaller_salto_nebula_booking_v1_Booking = GrpcMessageHelper.CreateMarshaller(Booking.Parser);

        static readonly Marshaller<GetBookingRequest> __Marshaller_salto_nebula_booking_v1_GetBookingRequest = GrpcMessageHelper.CreateMarshaller(GetBookingRequest.Parser);

        static readonly Marshaller<ListBookingsRequest> __Marshaller_salto_nebula_booking_v1_ListBookingsRequest = GrpcMessageHelper.CreateMarshaller(ListBookingsRequest.Parser);

        static readonly Marshaller<ListBookingsResponse> __Marshaller_salto_nebula_booking_v1_ListBookingsResponse = GrpcMessageHelper.CreateMarshaller(ListBookingsResponse.Parser);

        static readonly Marshaller<UpdateBookingRequest> __Marshaller_salto_nebula_booking_v1_UpdateBookingRequest = GrpcMessageHelper.CreateMarshaller(UpdateBookingRequest.Parser);

        static readonly Marshaller<DeleteBookingRequest> __Marshaller_salto_nebula_booking_v1_DeleteBookingRequest = GrpcMessageHelper.CreateMarshaller(DeleteBookingRequest.Parser);

        static readonly Marshaller<CheckInBookingRequest> __Marshaller_salto_nebula_booking_v1_CheckInBookingRequest = GrpcMessageHelper.CreateMarshaller(CheckInBookingRequest.Parser);

        static readonly Marshaller<CheckOutBookingRequest> __Marshaller_salto_nebula_booking_v1_CheckOutBookingRequest = GrpcMessageHelper.CreateMarshaller(CheckOutBookingRequest.Parser);

        static readonly Marshaller<CreateBookingUserRequest> __Marshaller_salto_nebula_booking_v1_CreateBookingUserRequest = GrpcMessageHelper.CreateMarshaller(CreateBookingUserRequest.Parser);

        static readonly Marshaller<BookingUser> __Marshaller_salto_nebula_booking_v1_BookingUser = GrpcMessageHelper.CreateMarshaller(BookingUser.Parser);

        static readonly Marshaller<GetBookingUserRequest> __Marshaller_salto_nebula_booking_v1_GetBookingUserRequest = GrpcMessageHelper.CreateMarshaller(GetBookingUserRequest.Parser);

        static readonly Marshaller<ListBookingUsersRequest> __Marshaller_salto_nebula_booking_v1_ListBookingUsersRequest = GrpcMessageHelper.CreateMarshaller(ListBookingUsersRequest.Parser);

        static readonly Marshaller<ListBookingUsersResponse> __Marshaller_salto_nebula_booking_v1_ListBookingUsersResponse = GrpcMessageHelper.CreateMarshaller(ListBookingUsersResponse.Parser);

        static readonly Marshaller<DeleteBookingUserRequest> __Marshaller_salto_nebula_booking_v1_DeleteBookingUserRequest = GrpcMessageHelper.CreateMarshaller(DeleteBookingUserRequest.Parser);
