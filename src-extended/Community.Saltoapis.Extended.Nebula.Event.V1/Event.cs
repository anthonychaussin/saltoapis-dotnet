namespace Saltoapis.Nebula.Event.V1
{
...
#endif
    {
        ...
        {
            get => EventReflection.Descriptor.MessageTypes[0];}
        ...
        public string Type
        {
            get => type_; set => type_ = ProtoPreconditions.CheckNotNull(value, "value");}
        ...
        {
            get => resource_; set => resource_ = ProtoPreconditions.CheckNotNull(value, "value");}
        ...
        {
            get => createTime_; set => createTime_ = value;}
        ...
        {
            get => occurTime_; set => occurTime_ = value;}
        ...
        public bool Equals(Event other)
        {
            ...
            if ((Name != other.Name) || (Type != other.Type) || (Resource != other.Resource) || (!Equals(CreateTime, other.CreateTime)) || (!Equals(OccurTime, other.OccurTime)) || (!Equals(Data, other.Data))) return false;
