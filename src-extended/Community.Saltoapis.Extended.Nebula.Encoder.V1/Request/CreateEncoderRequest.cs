namespace Saltoapis.Nebula.Encoder.V1.Request
{
...
#endif
    {
        ...
        public static MessageParser<CreateEncoderRequest> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => EncoderReflection.Descriptor.MessageTypes[1];}
        ...
        {
            get => encoderId_ ?? EncoderIdDefaultValue; set => encoderId_ = ProtoPreconditions.CheckNotNull(value, "value");}
        /// <summary>Gets whether the "encoder_id" field is set</summary>
        public bool HasEncoderId => encoderId_ != null;
        /// <summary>Clears the value of the "encoder_id" field</summary>
        public void ClearEncoderId() => encoderId_ = null;
        ...
        {
            get => encoder_; set => encoder_ = value;}
        ...
        public bool Equals(CreateEncoderRequest other)
        {
            ...
            if ((Parent != other.Parent) || (EncoderId != other.EncoderId) || !Equals(Encoder, other.Encoder)) return false;
