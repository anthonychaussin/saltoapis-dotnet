...
namespace Saltoapis.Nebula.Encoder.V1
{
    ...
    public static partial class EncoderService
    {
        ...
        static readonly Marshaller<CreateEncoderRequest> __Marshaller_salto_nebula_encoder_v1_CreateEncoderRequest = GrpcMessageHelper.CreateMarshaller(CreateEncoderRequest.Parser);

        static readonly Marshaller<Encoder> __Marshaller_salto_nebula_encoder_v1_Encoder = GrpcMessageHelper.CreateMarshaller(Encoder.Parser);

        static readonly Marshaller<GetEncoderRequest> __Marshaller_salto_nebula_encoder_v1_GetEncoderRequest = GrpcMessageHelper.CreateMarshaller(GetEncoderRequest.Parser);

        static readonly Marshaller<ListEncodersRequest> __Marshaller_salto_nebula_encoder_v1_ListEncodersRequest = GrpcMessageHelper.CreateMarshaller(ListEncodersRequest.Parser);

        static readonly Marshaller<ListEncodersResponse> __Marshaller_salto_nebula_encoder_v1_ListEncodersResponse = GrpcMessageHelper.CreateMarshaller(ListEncodersResponse.Parser);

        static readonly Marshaller<UpdateEncoderRequest> __Marshaller_salto_nebula_encoder_v1_UpdateEncoderRequest = GrpcMessageHelper.CreateMarshaller(UpdateEncoderRequest.Parser);

        static readonly Marshaller<DeleteEncoderRequest> __Marshaller_salto_nebula_encoder_v1_DeleteEncoderRequest = GrpcMessageHelper.CreateMarshaller(DeleteEncoderRequest.Parser);

        static readonly Marshaller<InitializeEncoderRequest> __Marshaller_salto_nebula_encoder_v1_InitializeEncoderRequest = GrpcMessageHelper.CreateMarshaller(InitializeEncoderRequest.Parser);
        ...
        static readonly Marshaller<ConfigureEncoderRequest> __Marshaller_salto_nebula_encoder_v1_ConfigureEncoderRequest = GrpcMessageHelper.CreateMarshaller(ConfigureEncoderRequest.Parser);

        static readonly Marshaller<ResetEncoderRequest> __Marshaller_salto_nebula_encoder_v1_ResetEncoderRequest = GrpcMessageHelper.CreateMarshaller(ResetEncoderRequest.Parser);

        static readonly Marshaller<UpdateEncoderFirmwareRequest> __Marshaller_salto_nebula_encoder_v1_UpdateEncoderFirmwareRequest = GrpcMessageHelper.CreateMarshaller(UpdateEncoderFirmwareRequest.Parser);

        static readonly Marshaller<BindEncoderRequest> __Marshaller_salto_nebula_encoder_v1_BindEncoderRequest = GrpcMessageHelper.CreateMarshaller(BindEncoderRequest.Parser);

        static readonly Marshaller<BindEncoderResponse> __Marshaller_salto_nebula_encoder_v1_BindEncoderResponse = GrpcMessageHelper.CreateMarshaller(BindEncoderResponse.Parser);

        static readonly Marshaller<UnbindEncoderRequest> __Marshaller_salto_nebula_encoder_v1_UnbindEncoderRequest = GrpcMessageHelper.CreateMarshaller(UnbindEncoderRequest.Parser);

        static readonly Marshaller<UnbindEncoderResponse> __Marshaller_salto_nebula_encoder_v1_UnbindEncoderResponse = GrpcMessageHelper.CreateMarshaller(UnbindEncoderResponse.Parser);

        static readonly Marshaller<ReadKeyRequest> __Marshaller_salto_nebula_encoder_v1_ReadKeyRequest = GrpcMessageHelper.CreateMarshaller(ReadKeyRequest.Parser);

        static readonly Marshaller<GenerateAuthorizationTokenRequest> __Marshaller_salto_nebula_encoder_v1_GenerateAuthorizationTokenRequest = GrpcMessageHelper.CreateMarshaller(GenerateAuthorizationTokenRequest.Parser);

        static readonly Marshaller<GenerateAuthorizationTokenResponse> __Marshaller_salto_nebula_encoder_v1_GenerateAuthorizationTokenResponse = GrpcMessageHelper.CreateMarshaller(GenerateAuthorizationTokenResponse.Parser);

        static readonly Marshaller<GenerateFirmwareDownloadUriRequest> __Marshaller_salto_nebula_encoder_v1_GenerateFirmwareDownloadUriRequest = GrpcMessageHelper.CreateMarshaller(GenerateFirmwareDownloadUriRequest.Parser);
