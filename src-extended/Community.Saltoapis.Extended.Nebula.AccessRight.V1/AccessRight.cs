namespace Saltoapis.Nebula.AccessRight.V1
{
...
#endif
    {
        ...
        public static MessageParser<AccessRight> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => AccessRightReflection.Descriptor.MessageTypes[0];}
        ...
        public bool Equals(AccessRight other)
        {
            ...
            if ((Name != other.Name) || (DisplayName != other.DisplayName) || !schedules_.Equals(other.schedules_)) return false;
