namespace Saltoapis.Nebula.AccessRight.V1
{
...
#endif
    {
        ...
        public static MessageParser<AccessRightAccessPointGroup> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => AccessRightReflection.Descriptor.MessageTypes[2];}
        ...
        {
            get => accessPointGroup_; set => accessPointGroup_ = ProtoPreconditions.CheckNotNull(value, "value");}
        ...
        public bool Equals(AccessRightAccessPointGroup other)
        {
            ...
            if ((Name != other.Name) || (AccessPointGroup != other.AccessPointGroup) || DisplayName != other.DisplayName) return false;
