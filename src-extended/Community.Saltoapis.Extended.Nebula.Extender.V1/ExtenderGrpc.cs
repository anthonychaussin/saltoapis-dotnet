...
namespace Saltoapis.Nebula.Extender.V1
{
    ...
    public static partial class ExtenderService
    {
        ...
        static readonly Marshaller<CreateExtenderRequest> __Marshaller_salto_nebula_extender_v1_CreateExtenderRequest = GrpcMessageHelper.CreateMarshaller(CreateExtenderRequest.Parser);

        static readonly Marshaller<Extender> __Marshaller_salto_nebula_extender_v1_Extender = GrpcMessageHelper.CreateMarshaller(Extender.Parser);

        static readonly Marshaller<GetExtenderRequest> __Marshaller_salto_nebula_extender_v1_GetExtenderRequest = GrpcMessageHelper.CreateMarshaller(GetExtenderRequest.Parser);

        static readonly Marshaller<ListExtendersRequest> __Marshaller_salto_nebula_extender_v1_ListExtendersRequest = GrpcMessageHelper.CreateMarshaller(ListExtendersRequest.Parser);

        static readonly Marshaller<ListExtendersResponse> __Marshaller_salto_nebula_extender_v1_ListExtendersResponse = GrpcMessageHelper.CreateMarshaller(ListExtendersResponse.Parser);

        static readonly Marshaller<UpdateExtenderRequest> __Marshaller_salto_nebula_extender_v1_UpdateExtenderRequest = GrpcMessageHelper.CreateMarshaller(UpdateExtenderRequest.Parser);

        static readonly Marshaller<DeleteExtenderRequest> __Marshaller_salto_nebula_extender_v1_DeleteExtenderRequest = GrpcMessageHelper.CreateMarshaller(DeleteExtenderRequest.Parser);

        static readonly Marshaller<BindExtenderRequest> __Marshaller_salto_nebula_extender_v1_BindExtenderRequest = GrpcMessageHelper.CreateMarshaller(BindExtenderRequest.Parser);

        static readonly Marshaller<BindExtenderResponse> __Marshaller_salto_nebula_extender_v1_BindExtenderResponse = GrpcMessageHelper.CreateMarshaller(BindExtenderResponse.Parser);

        static readonly Marshaller<UnbindExtenderRequest> __Marshaller_salto_nebula_extender_v1_UnbindExtenderRequest = GrpcMessageHelper.CreateMarshaller(UnbindExtenderRequest.Parser);

        static readonly Marshaller<UnbindExtenderResponse> __Marshaller_salto_nebula_extender_v1_UnbindExtenderResponse = GrpcMessageHelper.CreateMarshaller(UnbindExtenderResponse.Parser);

        static readonly Marshaller<UpdateExtenderFirmwareRequest> __Marshaller_salto_nebula_extender_v1_UpdateExtenderFirmwareRequest = GrpcMessageHelper.CreateMarshaller(UpdateExtenderFirmwareRequest.Parser);
        ...
        static readonly Marshaller<ResetExtenderRequest> __Marshaller_salto_nebula_extender_v1_ResetExtenderRequest = GrpcMessageHelper.CreateMarshaller(ResetExtenderRequest.Parser);

        static readonly Marshaller<GenerateFirmwareDownloadUriRequest> __Marshaller_salto_nebula_extender_v1_GenerateFirmwareDownloadUriRequest = GrpcMessageHelper.CreateMarshaller(GenerateFirmwareDownloadUriRequest.Parser);
