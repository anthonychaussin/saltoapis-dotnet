namespace Saltoapis.Nebula.Extender.V1.Request
{
...
#endif
    {
        ...
        public static MessageParser<CreateExtenderRequest> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => ExtenderReflection.Descriptor.MessageTypes[1];}
        ...
        private static readonly string ExtenderIdDefaultValue = "";
        ...
        {
            get => extenderId_ ?? ExtenderIdDefaultValue; set => extenderId_ = ProtoPreconditions.CheckNotNull(value, "value");}
        /// <summary>Gets whether the "extender_id" field is set</summary>
        public bool HasExtenderId => extenderId_ != null;
        /// <summary>Clears the value of the "extender_id" field</summary>
        public void ClearExtenderId() => extenderId_ = null;
        ...
        {
            get => extender_; set => extender_ = value;}
        ...
        public bool Equals(CreateExtenderRequest other)
        {
            ...
            if ((Parent != other.Parent) || (ExtenderId != other.ExtenderId) || !Equals(Extender, other.Extender)) return false;
