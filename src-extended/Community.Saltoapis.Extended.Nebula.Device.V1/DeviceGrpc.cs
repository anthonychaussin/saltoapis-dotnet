...
namespace Saltoapis.Nebula.Device.V1
{
    ...
    public static partial class DeviceService
    {
        ...
        static readonly Marshaller<GetDeviceRequest> __Marshaller_salto_nebula_device_v1_GetDeviceRequest = GrpcMessageHelper.CreateMarshaller(GetDeviceRequest.Parser);

        static readonly Marshaller<Device> __Marshaller_salto_nebula_device_v1_Device = GrpcMessageHelper.CreateMarshaller(Device.Parser);

        static readonly Marshaller<ListDevicesRequest> __Marshaller_salto_nebula_device_v1_ListDevicesRequest = GrpcMessageHelper.CreateMarshaller(ListDevicesRequest.Parser);

        static readonly Marshaller<ListDevicesResponse> __Marshaller_salto_nebula_device_v1_ListDevicesResponse = GrpcMessageHelper.CreateMarshaller(ListDevicesResponse.Parser);
