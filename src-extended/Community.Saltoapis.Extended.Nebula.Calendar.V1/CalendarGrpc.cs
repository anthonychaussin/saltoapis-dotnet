...
namespace Saltoapis.Nebula.Calendar.V1
{
    ...
    public static partial class CalendarService
    {
        ...
        static readonly Marshaller<CreateCalendarRequest> __Marshaller_salto_nebula_calendar_v1_CreateCalendarRequest = GrpcMessageHelper.CreateMarshaller(CreateCalendarRequest.Parser);

        static readonly Marshaller<Calendar> __Marshaller_salto_nebula_calendar_v1_Calendar = GrpcMessageHelper.CreateMarshaller(Calendar.Parser);

        static readonly Marshaller<GetCalendarRequest> __Marshaller_salto_nebula_calendar_v1_GetCalendarRequest = GrpcMessageHelper.CreateMarshaller(GetCalendarRequest.Parser);

        static readonly Marshaller<ListCalendarsRequest> __Marshaller_salto_nebula_calendar_v1_ListCalendarsRequest = GrpcMessageHelper.CreateMarshaller(ListCalendarsRequest.Parser);

        static readonly Marshaller<ListCalendarsResponse> __Marshaller_salto_nebula_calendar_v1_ListCalendarsResponse = GrpcMessageHelper.CreateMarshaller(ListCalendarsResponse.Parser);

        static readonly Marshaller<UpdateCalendarRequest> __Marshaller_salto_nebula_calendar_v1_UpdateCalendarRequest = GrpcMessageHelper.CreateMarshaller(UpdateCalendarRequest.Parser);

        static readonly Marshaller<DeleteCalendarRequest> __Marshaller_salto_nebula_calendar_v1_DeleteCalendarRequest = GrpcMessageHelper.CreateMarshaller(DeleteCalendarRequest.Parser);

        static readonly Marshaller<CreateEventRequest> __Marshaller_salto_nebula_calendar_v1_CreateEventRequest = GrpcMessageHelper.CreateMarshaller(CreateEventRequest.Parser);

        static readonly Marshaller<Event> __Marshaller_salto_nebula_calendar_v1_Event = GrpcMessageHelper.CreateMarshaller(Event.Parser);

        static readonly Marshaller<GetEventRequest> __Marshaller_salto_nebula_calendar_v1_GetEventRequest = GrpcMessageHelper.CreateMarshaller(GetEventRequest.Parser);

        static readonly Marshaller<ListEventsRequest> __Marshaller_salto_nebula_calendar_v1_ListEventsRequest = GrpcMessageHelper.CreateMarshaller(ListEventsRequest.Parser);

        static readonly Marshaller<ListEventsResponse> __Marshaller_salto_nebula_calendar_v1_ListEventsResponse = GrpcMessageHelper.CreateMarshaller(ListEventsResponse.Parser);

        static readonly Marshaller<UpdateEventRequest> __Marshaller_salto_nebula_calendar_v1_UpdateEventRequest = GrpcMessageHelper.CreateMarshaller(UpdateEventRequest.Parser);

        static readonly Marshaller<DeleteEventRequest> __Marshaller_salto_nebula_calendar_v1_DeleteEventRequest = GrpcMessageHelper.CreateMarshaller(DeleteEventRequest.Parser);
