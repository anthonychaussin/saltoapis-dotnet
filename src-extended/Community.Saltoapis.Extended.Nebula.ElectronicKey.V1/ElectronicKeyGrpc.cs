...
namespace Saltoapis.Nebula.ElectronicKey.V1
{
    ...
    public static partial class ElectronicKeyService
    {
        ...
        static readonly Marshaller<CreateElectronicKeyRequest> __Marshaller_salto_nebula_electronickey_v1_CreateElectronicKeyRequest = GrpcMessageHelper.CreateMarshaller(CreateElectronicKeyRequest.Parser);

        static readonly Marshaller<ElectronicKey> __Marshaller_salto_nebula_electronickey_v1_ElectronicKey = GrpcMessageHelper.CreateMarshaller(ElectronicKey.Parser);

        static readonly Marshaller<GetElectronicKeyRequest> __Marshaller_salto_nebula_electronickey_v1_GetElectronicKeyRequest = GrpcMessageHelper.CreateMarshaller(GetElectronicKeyRequest.Parser);

        static readonly Marshaller<ListElectronicKeysRequest> __Marshaller_salto_nebula_electronickey_v1_ListElectronicKeysRequest = GrpcMessageHelper.CreateMarshaller(ListElectronicKeysRequest.Parser);

        static readonly Marshaller<ListElectronicKeysResponse> __Marshaller_salto_nebula_electronickey_v1_ListElectronicKeysResponse = GrpcMessageHelper.CreateMarshaller(ListElectronicKeysResponse.Parser);

        static readonly Marshaller<UpdateElectronicKeyRequest> __Marshaller_salto_nebula_electronickey_v1_UpdateElectronicKeyRequest = GrpcMessageHelper.CreateMarshaller(UpdateElectronicKeyRequest.Parser);

        static readonly Marshaller<DeleteElectronicKeyRequest> __Marshaller_salto_nebula_electronickey_v1_DeleteElectronicKeyRequest = GrpcMessageHelper.CreateMarshaller(DeleteElectronicKeyRequest.Parser);

        static readonly Marshaller<BindElectronicKeyRequest> __Marshaller_salto_nebula_electronickey_v1_BindElectronicKeyRequest = GrpcMessageHelper.CreateMarshaller(BindElectronicKeyRequest.Parser);

        static readonly Marshaller<BindElectronicKeyResponse> __Marshaller_salto_nebula_electronickey_v1_BindElectronicKeyResponse = GrpcMessageHelper.CreateMarshaller(BindElectronicKeyResponse.Parser);

        static readonly Marshaller<UnbindElectronicKeyRequest> __Marshaller_salto_nebula_electronickey_v1_UnbindElectronicKeyRequest = GrpcMessageHelper.CreateMarshaller(UnbindElectronicKeyRequest.Parser);

        static readonly Marshaller<UnbindElectronicKeyResponse> __Marshaller_salto_nebula_electronickey_v1_UnbindElectronicKeyResponse = GrpcMessageHelper.CreateMarshaller(UnbindElectronicKeyResponse.Parser);

        static readonly Marshaller<InitializeElectronicKeyRequest> __Marshaller_salto_nebula_electronickey_v1_InitializeElectronicKeyRequest = GrpcMessageHelper.CreateMarshaller(InitializeElectronicKeyRequest.Parser);
        ...
        static readonly Marshaller<ConfigureElectronicKeyRequest> __Marshaller_salto_nebula_electronickey_v1_ConfigureElectronicKeyRequest = GrpcMessageHelper.CreateMarshaller(ConfigureElectronicKeyRequest.Parser);

        static readonly Marshaller<ResetElectronicKeyRequest> __Marshaller_salto_nebula_electronickey_v1_ResetElectronicKeyRequest = GrpcMessageHelper.CreateMarshaller(ResetElectronicKeyRequest.Parser);

        static readonly Marshaller<GenerateAuthorizationTokenRequest> __Marshaller_salto_nebula_electronickey_v1_GenerateAuthorizationTokenRequest = GrpcMessageHelper.CreateMarshaller(GenerateAuthorizationTokenRequest.Parser);

        static readonly Marshaller<GenerateAuthorizationTokenResponse> __Marshaller_salto_nebula_electronickey_v1_GenerateAuthorizationTokenResponse = GrpcMessageHelper.CreateMarshaller(GenerateAuthorizationTokenResponse.Parser);

        static readonly Marshaller<GenerateFirmwareDownloadUriRequest> __Marshaller_salto_nebula_electronickey_v1_GenerateFirmwareDownloadUriRequest = GrpcMessageHelper.CreateMarshaller(GenerateFirmwareDownloadUriRequest.Parser);
