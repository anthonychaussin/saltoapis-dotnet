namespace Saltoapis.Nebula.ElectronicKey.V1.Request
{
...
#endif
    {
        ...
        {
            get => ElectronicKeyReflection.Descriptor.MessageTypes[22];}
        ...
        {
            get => electronicKey_; set => electronicKey_ = ProtoPreconditions.CheckNotNull(value, "value");}
...
return ElectronicKey != other.ElectronicKey ? false : Equals(_unknownFields, other._unknownFields);
        }
