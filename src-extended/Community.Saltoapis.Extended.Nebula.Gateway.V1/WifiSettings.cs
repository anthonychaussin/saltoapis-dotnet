namespace Saltoapis.Nebula.Gateway.V1
{
...
#endif
    {
        ...
        public static MessageParser<WifiSettings> Parser { get => _parser;}

        public static MessageDescriptor Descriptor
        {
            get => GatewayReflection.Descriptor.MessageTypes[2];}
        ...
        public string Ssid
        {
            get => ssid_; set => ssid_ = ProtoPreconditions.CheckNotNull(value, "value");}
        ...
        {
            get => password_ ?? PasswordDefaultValue; set => password_ = ProtoPreconditions.CheckNotNull(value, "value");}
        /// <summary>Gets whether the "password" field is set</summary>
        public bool HasPassword => password_ != null;
        /// <summary>Clears the value of the "password" field</summary>
        public void ClearPassword() => password_ = null;
        ...
        public bool Equals(WifiSettings other)
        {
            ...
            if ((!Equals(Ipv4Settings, other.Ipv4Settings)) || (!Equals(DnsSettings, other.DnsSettings)) || (Ssid != other.Ssid) || (Password != other.Password)) return false;
