...
namespace Saltoapis.Nebula.Gateway.V1
{
    ...
    public static partial class GatewayService
    {
        ...
        static readonly Marshaller<CreateGatewayRequest> __Marshaller_salto_nebula_gateway_v1_CreateGatewayRequest = GrpcMessageHelper.CreateMarshaller(CreateGatewayRequest.Parser);

        static readonly Marshaller<Gateway> __Marshaller_salto_nebula_gateway_v1_Gateway = GrpcMessageHelper.CreateMarshaller(Gateway.Parser);

        static readonly Marshaller<GetGatewayRequest> __Marshaller_salto_nebula_gateway_v1_GetGatewayRequest = GrpcMessageHelper.CreateMarshaller(GetGatewayRequest.Parser);

        static readonly Marshaller<ListGatewaysRequest> __Marshaller_salto_nebula_gateway_v1_ListGatewaysRequest = GrpcMessageHelper.CreateMarshaller(ListGatewaysRequest.Parser);

        static readonly Marshaller<ListGatewaysResponse> __Marshaller_salto_nebula_gateway_v1_ListGatewaysResponse = GrpcMessageHelper.CreateMarshaller(ListGatewaysResponse.Parser);

        static readonly Marshaller<UpdateGatewayRequest> __Marshaller_salto_nebula_gateway_v1_UpdateGatewayRequest = GrpcMessageHelper.CreateMarshaller(UpdateGatewayRequest.Parser);

        static readonly Marshaller<DeleteGatewayRequest> __Marshaller_salto_nebula_gateway_v1_DeleteGatewayRequest = GrpcMessageHelper.CreateMarshaller(DeleteGatewayRequest.Parser);

        static readonly Marshaller<BindGatewayRequest> __Marshaller_salto_nebula_gateway_v1_BindGatewayRequest = GrpcMessageHelper.CreateMarshaller(BindGatewayRequest.Parser);

        static readonly Marshaller<BindGatewayResponse> __Marshaller_salto_nebula_gateway_v1_BindGatewayResponse = GrpcMessageHelper.CreateMarshaller(BindGatewayResponse.Parser);

        static readonly Marshaller<UnbindGatewayRequest> __Marshaller_salto_nebula_gateway_v1_UnbindGatewayRequest = GrpcMessageHelper.CreateMarshaller(UnbindGatewayRequest.Parser);

        static readonly Marshaller<UnbindGatewayResponse> __Marshaller_salto_nebula_gateway_v1_UnbindGatewayResponse = GrpcMessageHelper.CreateMarshaller(UnbindGatewayResponse.Parser);

        static readonly Marshaller<InitializeGatewayRequest> __Marshaller_salto_nebula_gateway_v1_InitializeGatewayRequest = GrpcMessageHelper.CreateMarshaller(InitializeGatewayRequest.Parser);
        ...
        static readonly Marshaller<ConfigureGatewayRequest> __Marshaller_salto_nebula_gateway_v1_ConfigureGatewayRequest = GrpcMessageHelper.CreateMarshaller(ConfigureGatewayRequest.Parser);

        static readonly Marshaller<ResetGatewayRequest> __Marshaller_salto_nebula_gateway_v1_ResetGatewayRequest = GrpcMessageHelper.CreateMarshaller(ResetGatewayRequest.Parser);

        static readonly Marshaller<UpdateGatewayFirmwareRequest> __Marshaller_salto_nebula_gateway_v1_UpdateGatewayFirmwareRequest = GrpcMessageHelper.CreateMarshaller(UpdateGatewayFirmwareRequest.Parser);

        static readonly Marshaller<GenerateAuthorizationTokenRequest> __Marshaller_salto_nebula_gateway_v1_GenerateAuthorizationTokenRequest = GrpcMessageHelper.CreateMarshaller(GenerateAuthorizationTokenRequest.Parser);

        static readonly Marshaller<GenerateAuthorizationTokenResponse> __Marshaller_salto_nebula_gateway_v1_GenerateAuthorizationTokenResponse = GrpcMessageHelper.CreateMarshaller(GenerateAuthorizationTokenResponse.Parser);

        static readonly Marshaller<GenerateFirmwareDownloadUriRequest> __Marshaller_salto_nebula_gateway_v1_GenerateFirmwareDownloadUriRequest = GrpcMessageHelper.CreateMarshaller(GenerateFirmwareDownloadUriRequest.Parser);
