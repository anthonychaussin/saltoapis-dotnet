namespace Saltoapis.Nebula.Installation.V1
{
...
#endif
    {
        ...
        public bool Equals(PaymentMethod other)
        {
            ...
            if ((Name != other.Name) || (!Equals(Card, other.Card))) return false;
            if ((!Equals(DirectDebit, other.DirectDebit)) || (MethodCase != other.MethodCase)) return false;
      ...
      if (_unknownFields != null) {
        ...
        public void MergeFrom(PaymentMethod other)
        {
            ...
            {
                case MethodOneofCase.Card:
                    if (Card == null) Card = new Types.Card();
                    Card.MergeFrom(other.Card);
                    break;
                case MethodOneofCase.DirectDebit:
                    if (DirectDebit == null) DirectDebit = new Types.DirectDebit();
        ...
        public static partial class Types
        {
...
#endif
            {
                ...
                public bool Equals(Card other)
                {
                    if (other is null) return false;
                    if (ReferenceEquals(other, this)) return true;
                    if ((!Equals(ExpireDate, other.ExpireDate)) || (LastFour != other.LastFour)) return false;
                    if ((Brand != other.Brand) || (PaymentAuthorization != other.PaymentAuthorization)) return false;
                    return Equals(_unknownFields, other._unknownFields);
                }
          ...
          if (_unknownFields != null) {
            _unknownFields.WriteTo(output);
                ...
                public void MergeFrom(DirectDebit other)
                {
                    ...
                    {
                        case SchemeOneofCase.Sepa:
                            if (Sepa == null) Sepa = new Types.SEPA();
                ...
                public static partial class Types
                {
...
#endif
                    {
                        ...
                        public bool Equals(SEPA other)
                        {
                            if (other is null) return false;
                            if (ReferenceEquals(other, this)) return true;
                            if ((LastFour != other.LastFour) || (AccountHolder != other.AccountHolder)) return false;
