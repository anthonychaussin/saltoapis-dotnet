...
namespace Saltoapis.Nebula.OpeningModeSchedule.V1
{
    ...
    public static partial class OpeningModeScheduleService
    {
        ...
        static readonly Marshaller<CreateOpeningModeScheduleRequest> __Marshaller_salto_nebula_openingmodeschedule_v1_CreateOpeningModeScheduleRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, CreateOpeningModeScheduleRequest.Parser));

        static readonly Marshaller<OpeningModeSchedule> __Marshaller_salto_nebula_openingmodeschedule_v1_OpeningModeSchedule = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, OpeningModeSchedule.Parser));

        static readonly Marshaller<GetOpeningModeScheduleRequest> __Marshaller_salto_nebula_openingmodeschedule_v1_GetOpeningModeScheduleRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GetOpeningModeScheduleRequest.Parser));

        static readonly Marshaller<ListOpeningModeSchedulesRequest> __Marshaller_salto_nebula_openingmodeschedule_v1_ListOpeningModeSchedulesRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ListOpeningModeSchedulesRequest.Parser));

        static readonly Marshaller<ListOpeningModeSchedulesResponse> __Marshaller_salto_nebula_openingmodeschedule_v1_ListOpeningModeSchedulesResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ListOpeningModeSchedulesResponse.Parser));

        static readonly Marshaller<UpdateOpeningModeScheduleRequest> __Marshaller_salto_nebula_openingmodeschedule_v1_UpdateOpeningModeScheduleRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UpdateOpeningModeScheduleRequest.Parser));

        static readonly Marshaller<DeleteOpeningModeScheduleRequest> __Marshaller_salto_nebula_openingmodeschedule_v1_DeleteOpeningModeScheduleRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, DeleteOpeningModeScheduleRequest.Parser));
