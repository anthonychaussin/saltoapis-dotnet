...
namespace Saltoapis.Nebula.Device.V1
{
...
#endif
    {
      ...
      if (_unknownFields != null) {
        ...
        public int CalculateSize()
        {
            ...
            if (DeviceType != Type.DeviceType.Unspecified)
            {
                size += 1 + CodedOutputStream.ComputeEnumSize((int)DeviceType);
            }
            if (Source.Length != 0)
            {
        ...
        public void MergeFrom(Device other)
        {
            ...
            if (other.DeviceType != Type.DeviceType.Unspecified)
            {
    ...
    /// </summary>
    public sealed partial class GetDeviceRequest : IMessage<GetDeviceRequest>
#if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
        , IBufferMessage
#endif
    {
        private static readonly MessageParser<GetDeviceRequest> _parser = new(() => new GetDeviceRequest());
        private UnknownFieldSet _unknownFields;

        public static MessageParser<GetDeviceRequest> Parser { get { return _parser; } }

        public static MessageDescriptor Descriptor
        {
            get { return DeviceReflection.Descriptor.MessageTypes[1]; }
        }
        ...
        public GetDeviceRequest Clone() => new(this);
        /// <summary>Field number for the "name" field.</summary>
        public const int NameFieldNumber = 1;
        private string name_ = "";
        ...
        public override bool Equals(object other) => Equals(other as GetDeviceRequest);
    ...
    /// </summary>
    public sealed partial class ListDevicesRequest : IMessage<ListDevicesRequest>
#if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
        , IBufferMessage
#endif
    {
        private static readonly MessageParser<ListDevicesRequest> _parser = new(() => new ListDevicesRequest());
        private UnknownFieldSet _unknownFields;

        public static MessageParser<ListDevicesRequest> Parser { get { return _parser; } }

        public static MessageDescriptor Descriptor
        {
            get { return DeviceReflection.Descriptor.MessageTypes[2]; }
        }
        ...
        public ListDevicesRequest Clone() => new(this);
        ...
        public override bool Equals(object other) => Equals(other as ListDevicesRequest);
    ...
    /// </summary>
    public sealed partial class ListDevicesResponse : IMessage<ListDevicesResponse>
#if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
        , IBufferMessage
#endif
    {
        private static readonly MessageParser<ListDevicesResponse> _parser = new(() => new ListDevicesResponse());
        private UnknownFieldSet _unknownFields;

        public static MessageParser<ListDevicesResponse> Parser { get { return _parser; } }

        public static MessageDescriptor Descriptor
        {
            get { return DeviceReflection.Descriptor.MessageTypes[3]; }
        }
        ...
        public ListDevicesResponse Clone() => new(this);
        /// <summary>Field number for the "devices" field.</summary>
        public const int DevicesFieldNumber = 1;
        private static readonly FieldCodec<Device> _repeated_devices_codec
            = FieldCodec.ForMessage(10, Device.Parser);
        private readonly RepeatedField<Device> devices_ = [];
        ...
        /// in the request.
        /// </summary>
        public RepeatedField<Device> Devices
        {
            get { return devices_; }
        }
        ...
        public override bool Equals(object other) => Equals(other as ListDevicesResponse);
