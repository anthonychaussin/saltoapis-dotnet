...
namespace Saltoapis.Nebula.IntercomAdaptor.V1
{
    ...
    public static partial class IntercomAdaptorService
    {
        ...
        static readonly Marshaller<CreateIntercomAdaptorRequest> __Marshaller_salto_nebula_intercomadaptor_v1_CreateIntercomAdaptorRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, CreateIntercomAdaptorRequest.Parser));

        static readonly Marshaller<IntercomAdaptor> __Marshaller_salto_nebula_intercomadaptor_v1_IntercomAdaptor = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, IntercomAdaptor.Parser));

        static readonly Marshaller<GetIntercomAdaptorRequest> __Marshaller_salto_nebula_intercomadaptor_v1_GetIntercomAdaptorRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GetIntercomAdaptorRequest.Parser));

        static readonly Marshaller<ListIntercomAdaptorsRequest> __Marshaller_salto_nebula_intercomadaptor_v1_ListIntercomAdaptorsRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ListIntercomAdaptorsRequest.Parser));

        static readonly Marshaller<ListIntercomAdaptorsResponse> __Marshaller_salto_nebula_intercomadaptor_v1_ListIntercomAdaptorsResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ListIntercomAdaptorsResponse.Parser));

        static readonly Marshaller<UpdateIntercomAdaptorRequest> __Marshaller_salto_nebula_intercomadaptor_v1_UpdateIntercomAdaptorRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UpdateIntercomAdaptorRequest.Parser));

        static readonly Marshaller<DeleteIntercomAdaptorRequest> __Marshaller_salto_nebula_intercomadaptor_v1_DeleteIntercomAdaptorRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, DeleteIntercomAdaptorRequest.Parser));
        ...
        static readonly Marshaller<BindIntercomAdaptorRequest> __Marshaller_salto_nebula_intercomadaptor_v1_BindIntercomAdaptorRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, BindIntercomAdaptorRequest.Parser));

        static readonly Marshaller<BindIntercomAdaptorResponse> __Marshaller_salto_nebula_intercomadaptor_v1_BindIntercomAdaptorResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, BindIntercomAdaptorResponse.Parser));

        static readonly Marshaller<UnbindIntercomAdaptorRequest> __Marshaller_salto_nebula_intercomadaptor_v1_UnbindIntercomAdaptorRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UnbindIntercomAdaptorRequest.Parser));

        static readonly Marshaller<UnbindIntercomAdaptorResponse> __Marshaller_salto_nebula_intercomadaptor_v1_UnbindIntercomAdaptorResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UnbindIntercomAdaptorResponse.Parser));

        static readonly Marshaller<InitializeIntercomAdaptorRequest> __Marshaller_salto_nebula_intercomadaptor_v1_InitializeIntercomAdaptorRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, InitializeIntercomAdaptorRequest.Parser));
        ...
        static readonly Marshaller<ConfigureIntercomAdaptorRequest> __Marshaller_salto_nebula_intercomadaptor_v1_ConfigureIntercomAdaptorRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ConfigureIntercomAdaptorRequest.Parser));

        static readonly Marshaller<ResetIntercomAdaptorRequest> __Marshaller_salto_nebula_intercomadaptor_v1_ResetIntercomAdaptorRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ResetIntercomAdaptorRequest.Parser));

        static readonly Marshaller<UpdateIntercomAdaptorFirmwareRequest> __Marshaller_salto_nebula_intercomadaptor_v1_UpdateIntercomAdaptorFirmwareRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UpdateIntercomAdaptorFirmwareRequest.Parser));

        static readonly Marshaller<GenerateAuthorizationTokenRequest> __Marshaller_salto_nebula_intercomadaptor_v1_GenerateAuthorizationTokenRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GenerateAuthorizationTokenRequest.Parser));

        static readonly Marshaller<GenerateAuthorizationTokenResponse> __Marshaller_salto_nebula_intercomadaptor_v1_GenerateAuthorizationTokenResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GenerateAuthorizationTokenResponse.Parser));

        static readonly Marshaller<GenerateFirmwareDownloadUriRequest> __Marshaller_salto_nebula_intercomadaptor_v1_GenerateFirmwareDownloadUriRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GenerateFirmwareDownloadUriRequest.Parser));
