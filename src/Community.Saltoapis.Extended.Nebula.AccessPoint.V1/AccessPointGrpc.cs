...
namespace Saltoapis.Nebula.AccessPoint.V1
{
    ...
    public static partial class AccessPointService
    {
        ...
        static readonly Marshaller<CreateAccessPointRequest> __Marshaller_salto_nebula_accesspoint_v1_CreateAccessPointRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, CreateAccessPointRequest.Parser));

        static readonly Marshaller<AccessPoint> __Marshaller_salto_nebula_accesspoint_v1_AccessPoint = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, AccessPoint.Parser));

        static readonly Marshaller<GetAccessPointRequest> __Marshaller_salto_nebula_accesspoint_v1_GetAccessPointRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GetAccessPointRequest.Parser));

        static readonly Marshaller<ListAccessPointsRequest> __Marshaller_salto_nebula_accesspoint_v1_ListAccessPointsRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ListAccessPointsRequest.Parser));

        static readonly Marshaller<ListAccessPointsResponse> __Marshaller_salto_nebula_accesspoint_v1_ListAccessPointsResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ListAccessPointsResponse.Parser));

        static readonly Marshaller<UpdateAccessPointRequest> __Marshaller_salto_nebula_accesspoint_v1_UpdateAccessPointRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UpdateAccessPointRequest.Parser));

        static readonly Marshaller<DeleteAccessPointRequest> __Marshaller_salto_nebula_accesspoint_v1_DeleteAccessPointRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, DeleteAccessPointRequest.Parser));
        ...
        static readonly Marshaller<UnlockAccessPointRequest> __Marshaller_salto_nebula_accesspoint_v1_UnlockAccessPointRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UnlockAccessPointRequest.Parser));
        ...
        static readonly Marshaller<LockAccessPointRequest> __Marshaller_salto_nebula_accesspoint_v1_LockAccessPointRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, LockAccessPointRequest.Parser));
