namespace Saltoapis.Nebula.IntercomAdaptor.V1
{
...
#endif
    {
        ...
        public bool Equals(IntercomAdaptor other)
        {
            ...
            if ((Intercom != other.Intercom) || (!photos_.Equals(other.photos_))) return false;
            if ((!photoUris_.Equals(other.photoUris_)) || (!readings_.Equals(other.readings_))) return false;
