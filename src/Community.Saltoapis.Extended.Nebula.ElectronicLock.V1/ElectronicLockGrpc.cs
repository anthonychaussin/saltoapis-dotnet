...
namespace Saltoapis.Nebula.ElectronicLock.V1
{
    ...
    public static partial class ElectronicLockService
    {
        ...
        static readonly Marshaller<CreateElectronicLockRequest> __Marshaller_salto_nebula_electroniclock_v1_CreateElectronicLockRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, CreateElectronicLockRequest.Parser));

        static readonly Marshaller<ElectronicLock> __Marshaller_salto_nebula_electroniclock_v1_ElectronicLock = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ElectronicLock.Parser));

        static readonly Marshaller<GetElectronicLockRequest> __Marshaller_salto_nebula_electroniclock_v1_GetElectronicLockRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GetElectronicLockRequest.Parser));

        static readonly Marshaller<ListElectronicLocksRequest> __Marshaller_salto_nebula_electroniclock_v1_ListElectronicLocksRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ListElectronicLocksRequest.Parser));

        static readonly Marshaller<ListElectronicLocksResponse> __Marshaller_salto_nebula_electroniclock_v1_ListElectronicLocksResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ListElectronicLocksResponse.Parser));

        static readonly Marshaller<UpdateElectronicLockRequest> __Marshaller_salto_nebula_electroniclock_v1_UpdateElectronicLockRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UpdateElectronicLockRequest.Parser));

        static readonly Marshaller<DeleteElectronicLockRequest> __Marshaller_salto_nebula_electroniclock_v1_DeleteElectronicLockRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, DeleteElectronicLockRequest.Parser));
        ...
        static readonly Marshaller<BindElectronicLockRequest> __Marshaller_salto_nebula_electroniclock_v1_BindElectronicLockRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, BindElectronicLockRequest.Parser));

        static readonly Marshaller<BindElectronicLockResponse> __Marshaller_salto_nebula_electroniclock_v1_BindElectronicLockResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, BindElectronicLockResponse.Parser));

        static readonly Marshaller<UnbindElectronicLockRequest> __Marshaller_salto_nebula_electroniclock_v1_UnbindElectronicLockRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UnbindElectronicLockRequest.Parser));

        static readonly Marshaller<UnbindElectronicLockResponse> __Marshaller_salto_nebula_electroniclock_v1_UnbindElectronicLockResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UnbindElectronicLockResponse.Parser));

        static readonly Marshaller<InitializeElectronicLockRequest> __Marshaller_salto_nebula_electroniclock_v1_InitializeElectronicLockRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, InitializeElectronicLockRequest.Parser));
        ...
        static readonly Marshaller<ConfigureElectronicLockRequest> __Marshaller_salto_nebula_electroniclock_v1_ConfigureElectronicLockRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ConfigureElectronicLockRequest.Parser));

        static readonly Marshaller<ResetElectronicLockRequest> __Marshaller_salto_nebula_electroniclock_v1_ResetElectronicLockRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, ResetElectronicLockRequest.Parser));

        static readonly Marshaller<UpdateElectronicLockFirmwareRequest> __Marshaller_salto_nebula_electroniclock_v1_UpdateElectronicLockFirmwareRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, UpdateElectronicLockFirmwareRequest.Parser));

        static readonly Marshaller<GenerateAuthorizationTokenRequest> __Marshaller_salto_nebula_electroniclock_v1_GenerateAuthorizationTokenRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GenerateAuthorizationTokenRequest.Parser));

        static readonly Marshaller<GenerateAuthorizationTokenResponse> __Marshaller_salto_nebula_electroniclock_v1_GenerateAuthorizationTokenResponse = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GenerateAuthorizationTokenResponse.Parser));

        static readonly Marshaller<GenerateFirmwareDownloadUriRequest> __Marshaller_salto_nebula_electroniclock_v1_GenerateFirmwareDownloadUriRequest = Marshallers.Create(__Helper_SerializeMessage, context => __Helper_DeserializeMessage(context, GenerateFirmwareDownloadUriRequest.Parser));
